...
var SendForgotPasswordEmailService = /** @class */ (function () {
    ...
    SendForgotPasswordEmailService.prototype.execute = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var checkUserExists, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        token = this.userTokensRepository.generate(checkUserExists.id);
                        return [4 /*yield*/, this.mailProvider.sendMail(email, "Recuperação de Senha")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
