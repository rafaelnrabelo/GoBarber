...
describe("UpdateUserAvatar", function () {
    ...
    it("should not be able to update the avatar from a non existing user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("should delete the old avatar when updating to a new one", function () { return __awaiter(void 0, void 0, void 0, function () {
        var deletefile, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
