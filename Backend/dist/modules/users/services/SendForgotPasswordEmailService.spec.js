...
describe("SendForgotPasswordEmail", function () {
    ...
    it("should be able to send an email to recover the password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordEmail.execute("test@test.com")];
                case 2:
                    _a.sent();
    ...
    it("should not be able to send an email to a non existing user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordEmail.execute("non-existing-user@test.com")).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
