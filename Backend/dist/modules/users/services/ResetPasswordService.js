...
var SendForgotPasswordEmailService = /** @class */ (function () {
    function SendForgotPasswordEmailService(usersRepository, userTokensRepository, hashProvider) {
        this.usersRepository = usersRepository;
        this.userTokensRepository = userTokensRepository;
        this.hashProvider = hashProvider;
    }
    SendForgotPasswordEmailService.prototype.execute = function (token, password) {
        return __awaiter(this, void 0, void 0, function () {
            var userToken, user, compareDate, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        compareDate = date_fns_1.addHours(userToken.created_at, 2);
